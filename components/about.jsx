...
export const About = () => {
  return (
    <div className="grid grid-cols-2 gap-10 items-center mx-8 p-20 bg-[url('../assets/bg-image.svg')] bg-cover bg-fixed bg-no-repeat bg-bottom" id="about" >
        <div className="col-span-1 md:col-auto flex justify-end items-start about-img " width={510} height={500}>
        ...
        <h2 className="font-normal text-coutana-gray-100 text-center">About Us</h2>
            ...
            <p className="text-coutana-gray-100 text-base leading-6">
